...
# 1) XGBoost Tuned Hyperparameters Attempt 2 (NOT BEING USED)
```{r}
eta = exp(-4.31926)
max_depth = 6
...
XGBoost Tuned Hyper parameters 3 (BEST RESULT)
```{r}
...
```{r}
# Since there is no Cancer column in the test data set, 
#I will add it so that my task can have it as a target
